...
% Defaults typeface to Times New Roman
...
\sectionfont{\fontspec{Arial}\fontsize{18}{15}\selectfont}
...
\begin{document}
    ...
    \begin{center}
        ...
        {\fontsize{28pt}{14pt}\selectfont{\bfseries \fontspec{Arial} Aristotle Henderson}}
