...
\begin{document}
    ...
    \titlespacing*{\section}{-4pt}{8pt}{4pt}
    ...
    \section*{Work Experience}
        ...
        \begin{itemize}
            ...
            \item Empowered engineers to visualize and debug RTC calling with a novel handling system for unlimited data types and sources
